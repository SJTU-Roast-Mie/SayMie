/**
 * @license AngularJS v1.3.6-local+sha.52a57e3
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.6-local+sha.52a57e3/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.6-local+sha.52a57e3',    // all of these placeholder strings will be replaced by grunt's
